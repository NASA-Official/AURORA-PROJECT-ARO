...
class StampHomeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // viewPagerAdapter = CountryPlaceViewPagerAdapter(mContext, countryList)
        // viewPager.adapter = viewPagerAdapter


        //viewPager.addOnPageChangeListener(viewPagerPageChangeList)
    } // End of onViewCreated

//    private var viewPagerPageChangeList : ViewPager.OnPageChangeListener = object : ViewPager.OnPageChangeListener {
...
//            // 페이지 스크롤 이벤트
//        }
//    } // End of viewPagerPageChangeList
