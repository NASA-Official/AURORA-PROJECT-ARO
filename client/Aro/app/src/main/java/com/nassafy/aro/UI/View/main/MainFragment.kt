...
class MainFragment : BaseFragment<FragmentMainBinding>(FragmentMainBinding::inflate) {
    ...
    private fun initTabLayout() {
        ...
        tabIcon1.findViewById<ImageView>(R.id.tabicon_imageview).setBackgroundResource(R.drawable.tab_aurora_icon)
        tabIcon1.findViewById<TextView>(R.id.tabicon_textview).text = getString(R.string.service_aurora)
        val tabIcon2 = layoutInflater.inflate(R.layout.tab_icon_custom_view, null)
        tabIcon2.findViewById<ImageView>(R.id.tabicon_imageview).setBackgroundResource(R.drawable.tab_meteor_shower_icon)
        tabIcon2.findViewById<TextView>(R.id.tabicon_textview).text = getString(R.string.service_meteor_shower)
